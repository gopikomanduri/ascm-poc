...
def main():
    ...
    # ---------------------------------------------------------
    # STEP 3: PRE-FLIGHT BUDGET RADAR & LOCAL BLUEPRINT BANK
    # ---------------------------------------------------------
    print("\n" + "-" * 70)
    print("📊 STEP 3: Pre-Flight Budget Radar & Zero-Token Blueprint Engine")
    print("-" * 70)
    ...
    # ---------------------------------------------------------
    # STEP 4: AUTONOMOUS MULTI-AGENT SPRINT
    # ---------------------------------------------------------
    print("\n" + "-" * 70)
    ...
    biz_result = biz_agent.run(
        user_goal=goal,
        clarified_prd="Non-custodial cryptocurrency checkout for USDT, USDC, and ETH with gas-optimized settlement and double-spend rejection.",
